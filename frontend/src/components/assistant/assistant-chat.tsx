    ...
    >
      {open && (
        <section
          ...
          className="ui-pop-in absolute bottom-16 left-0 flex max-h-[min(32rem,calc(70dvh-5.5rem))] w-[min(25rem,calc(100vw-3rem))] flex-col overflow-hidden rounded-[var(--radius-xl)] border border-[var(--color-line)] bg-white shadow-[var(--shadow-card)] lg:w-[min(25rem,calc(100vw-32rem))]"
        >
      ...
      <button
        ...
        className="ui-button-icon ui-soft-focus flex size-14 items-center justify-center rounded-full border border-white/90 bg-white/90 p-2 text-[var(--color-primary-strong)] shadow-[var(--shadow-float)] backdrop-blur-xl focus-visible:outline-none"
      >
        <svg
          viewBox="0 0 48 48"
          fill="none"
